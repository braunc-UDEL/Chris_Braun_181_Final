...
public class Retirement {
	...
	public double MonthlySavings() {
		double pmt = 0;
		pmt = Math.abs(PMT(this.dAnnualReturnWorking/100/12,this.iYearsToWork*12,0,TotalAmountToSave(),false));
	...
	public double TotalAmountToSave() {
		...
		double pv = 0;
		pv = Math.abs(PV(this.dAnnualReturnRetired/100/12,this.iYearsRetired*12,this.dRequiredIncome-this.dMonthlySSI,0,false));
